# Verify/Check Mode for `setup-agent-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-agent-skills`.
...
- #106 — Feature request: verify/check mode for setup-agent-skills
