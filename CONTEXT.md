...
A collection of opencode agent skills (slash commands and behaviors). Skills are organized into buckets and consumed by per-repo configuration emitted by `/setup-agent-skills`.
